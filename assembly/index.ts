...
//almacenar cuánto NEAR se incluyó en el drop para cada cuenta
...
//Permite la clave pública dada para reclamar el saldo enviado.
//Toma ACCESS_KEY_ALLOWANCE como tarifa desde el depósito para cubrir la creación de la cuenta a través de una clave de acceso.
//# [pagadero]: tenga en cuenta que los métodos de contrato de AS no controlan el depósito adjunto 
 ...
 * Argumentos de devolución de llamada para la cuenta creada
 */
@nearBindgen
 ...
 * Devolución de llamada después de crear una cuenta y reclamar el linkdrop. 
 * @param amount
 */
 ...
 * Devuelve los fondos de linkdrop asociados con una clave pública determinada. 
 * @param public_key
 */
